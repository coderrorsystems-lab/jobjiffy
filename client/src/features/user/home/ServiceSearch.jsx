...
import { searchProfessionalByUserId as searchProfessionalByUserIdAPI } from '../services/homeAPI';
...
export default function ServiceSearch() {
  ...
  const searchProfessionalByIdAPI = async (userId) => {
    try {
      const data = await searchProfessionalByUserIdAPI(userId);
